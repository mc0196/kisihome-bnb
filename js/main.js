...
const translations = {
  en: {
    ...
    'amenities.views.title': 'Lake Views',
    'amenities.views.desc': 'Wake up to stunning views of Lake Como from the terrace',
  ...
  it: {
    ...
    'amenities.views.title': 'Vista sul lago',
    'amenities.views.desc': 'Svegliatevi con la vista sul Lago di Como dalla terrazza',
